...
namespace ASP.NET_RazorPage_P8.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // http://localhost:5149/confirm-email?userId=gia-tri-nao-do-sinh&code=gia-tri-nao-do&returnUrl=returnUrlOTren
